...
<head>
	...
	<link rel="stylesheet" href="../assets/css/vendorpl.css">
		...
		<div style="overflow: overlay;">
			<table>
				...
				<tbody>
					...
					<tr>
						<td>
							<img src=<?php echo "'" . $play['image'] . "'"; ?>
							alt=<?php echo "'" . $play['title'] . "'"; ?>>
							<p><?php echo $play['title']; ?></p>
						</td>
						...
						<a href=<?php echo "'../controllers/deletePlay.php?id=" . $play['id'] . "'"; ?>><i class="fa-solid fa-trash"></i></a>
						</td>
					</tr>
					<?php }} ?>
				</tbody>
